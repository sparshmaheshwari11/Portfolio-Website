            ...
            <div className="home_container container grid">
                <div className="home_content grid">
                    <div className="home_social">
                        <a href="https://www.linkedin.com/in/sparsh-maheshwari-144b3a229/" className="home_social-icon" target="_blank">
                            <FaLinkedin />
                        </a>
                        <a href="https://leetcode.com/u/Sparsh_2001/" className="home_social-icon" target="_blank">
                            <SiLeetcode />
                        </a>
                        <a href="https://www.instagram.com/sparsh._.maheshwari/" className="home_social-icon" target="_blank">
                            <FaInstagram />
                        </a>
                        <a href="https://github.com/sparshmaheshwari11" className="home_social-icon" target="_blank">
                            <FaGithub />
                        </a>
                    ...
                    <div className="home_data">
                        ...
                        <h1 className="heading-name">
                            <strong className="main-name">Sparsh Maheswari</strong>
                        </h1>
